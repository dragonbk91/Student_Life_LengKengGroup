...
public class Introduction extends ManageableScene implements IManageableScene{
	...
	public Introduction(BaseGameActivity context) {
		super();
	...
	public void loadResources(BaseGameActivity context) {	
      ...
      //load
		...
		BitmapTextureAtlasTextureRegionFactory.setAssetBasePath("gfx/game script/introduction/");
		// background
